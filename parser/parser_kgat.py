...
def parse_kgat_args():
    ...
    parser.add_argument('--embed_method', type=str, default='TransR',
                        help='Embedding method. (TransR, TransE)')
    parser.add_argument('--margin', type=float, default=0.5,
                        help='Margin value for TransE.')
    ...
    save_dir = 'trained_model/KGAT/{}/{}embed-dim{}_relation-dim{}_{}_{}_{}_lr{}_pretrain{}/'.format(
        args.data_name, args.embed_method+str(args.margin), args.embed_dim, args.relation_dim, args.laplacian_type, args.aggregation_type,
