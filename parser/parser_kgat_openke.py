...
def parse_kgat_args():
    ...
    # openke
    parser.add_argument('--kg_embedding_model_name', type=str, default="transd",
                        help='Knowledge graph embedding model.')
    parser.add_argument('--type_constrain', type=bool, default=False)

    args = parser.parse_args()

    save_dir = 'trained_model/KGAT/{}/constrain_{}-embed_{}-dim{}_relation-dim{}_{}_{}_{}_lr{}_pretrain{}/'.format(
        args.data_name, args.type_constrain, args.kg_embedding_model_name, args.embed_dim, args.relation_dim,
        args.laplacian_type, args.aggregation_type, '-'.join([str(i) for i in eval(args.conv_dim_list)]), args.lr,
        args.use_pretrain)
